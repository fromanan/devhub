    ...
    <div class="container">
        ...
        <div class="doc-body row">
            ...
            <div class="doc-sidebar col-md-3 col-12 order-0 d-none d-md-flex">
                <?php echo new StarForged\SideBar("data/sidebar-components.json") ?>
            </div><!--//doc-sidebar-->
        </div><!--//doc-body-->
    </div><!--//container-->
</div><!--//doc-wrapper-->
                ...
                <div class="content-holder col-lg-7 col-md-6 col-12">
                    <div class="content-holder-inner">
                        <div class="desc">
                            ...
                            <p>Check out <a href="https://themes.3rdwavemedia.com/bootstrap-templates/portfolio/instance-bootstrap-portfolio-theme-for-developers/"
