                    ...
                    <div class="doc-content col-md-9 col-12 order-1">
                        <div class="content-inner">
                            ...
                            <section id="tables-section" class="doc-section">
                                ...
                                <div class="section-block">
                                    <?php new Table("table-1.json", TableType::BASIC) ?>
                                    <?php new Table("table-2.json", TableType::STRIPED) ?>
                                    <?php new Table("table-3.json", TableType::BORDERED) ?>
                                </div><!--//section-block-->
                            </section><!--//doc-section-->
